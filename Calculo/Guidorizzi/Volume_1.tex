...
\]
	...
	\item % S. 1.2 - Ex. 20
		...
		\item  % S. 1.2 - Ex. 20 - c
			...
			\begin{list}{•}
			\item
			$x-2 \leq 0$ e $x+2 \leq 0$ resultam em, respectivamente, $x \leq 2$ e $x \leq -2$. Devemos ter $x \geq -3$, que resulta na solução: \\
			$-3 \leq x \leq -2$
			\item\item
			$ x-2 \leq 0$ e $x+3 \leq 0$ resultam em, respectivamente, $x \leq 2$ e $x \leq -3$. Devemos ter $x+2 \geq 0 \Rightarrow x \geq -2$, que não é possível.
			\item
			$ x+2 \leq 0$ e $x+3 \leq 0$ resultam em, respectivamente, $x \leq -2$ e $x \leq -3$. Devemos ter $x-2 \geq 0 \Rightarrow x \geq 2$, que não é possível.
			\end{list}
	...
	\item % S. 1.2 - Ex. 23
		\begin{enumerate}
			...
			$\Leftrightarrow x^2 - y^2 + 0 = 0$\\
			$\Leftrightarrow x^2 - y^2 + xy - xy = 0$\\
			$\Leftrightarrow x^2 + xy - xy - y^2 = 0$\\
			$\Leftrightarrow x(x + y) - y(x + y) = 0$\\
			$\Leftrightarrow (x + y)(x - y) = 0$\\
			$\Leftrightarrow x + y = 0$ ou $x - y = 0$\\
			$\Leftrightarrow x = -y$ ou $x = y$
			\item % S. 1.2 - Ex. 23 - h
