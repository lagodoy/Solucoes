	...
	\begin{enumerate}
		...
		\begin{tikzpicture}[>=latex]
			\begin{axis}[
				...
				ymin=-4.5,
		  		ymax=4.5]
			\addplot [smooth][mark=none,domain=-4.5:-1.65] {(x*(2*x-1))/(x+1))};
			\addplot [smooth][mark=none,domain=-1.33:4] {(x*(2*x-1))/(x+1)))};
			\end{axis}
			\draw[dashed] (2.29,5.65) -- (2.29,0.05);
		\end{tikzpicture}\\
		$f(x) >0$ se $x < -\dfrac{3}{2}$ ou  $x>0$, $f(x)=0$ se $x = 0$, $f(x) < 0$ se $-\dfrac{3}{2}< x <0$.		
		...
		\begin{tikzpicture}[>=latex]
			\begin{axis}[
				...
				ymin=-4.5,
		  		ymax=4.5]
			\addplot [smooth][mark=none,domain=-4.5:-1.65] {(2*x-3)/((1-x)*(1-2*x))};
			\addplot [smooth][mark=none,domain=-1.33:4] {(2*x-3)/((1-x)*(1-2*x))};
			\end{axis}
			\draw[dashed] (2.29,5.65) -- (2.29,0.05);
		\end{tikzpicture}\\
		$f(x) >0$ se $x < -\dfrac{3}{2}$ ou  $x>0$, $f(x)=0$ se $x = 0$, $f(x) < 0$ se $-\dfrac{3}{2}< x <0$.		
